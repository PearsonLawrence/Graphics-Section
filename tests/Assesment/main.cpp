...
void SetSkybox()
{
	faces =
	{
	  ...
	  sky_geo = loader.loadGeo("cube.obj");// loadGeometry("../../resources/models/cube.obj");
	  sky_map = loadCubemap(faces);
	  sky_model = glm::scale(glm::vec3(20, 20, 20));
	  sky_shader = loader.loadShaderAsset("Skybox.vert", "Skybox.frag");//loadShader("../../resources/shaders/Skybox.vert", "../../resources/shaders/Skybox.frag");
